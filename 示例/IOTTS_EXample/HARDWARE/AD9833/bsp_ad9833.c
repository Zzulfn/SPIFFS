...
SCK    ___________    __    __    __    __    __    __    __    __
                  |__|  |__|  |__|  |__|  |__|  |__|  |__|  |__|  |

FSYNC  _________
                |___________________________________________________________________//控制低有效

                      _____
DATA   ---------_____|     |_____| //数据在SCK下降沿送入移位寄存器
*********************************************************************************************************
*/
...
void AD9833_WaveSeting(double Freq,unsigned int Freq_SFR,unsigned int WaveMode,unsigned int Phase )
{
		...
		AD9833_Write(0x0100); //复位AD9833,即RESET位为1 //0000 0001 0000 0000
		AD9833_Write(0x2100); //选择数据一次写入，B28位和RESET位为1 //0010 0001 0000 0000
